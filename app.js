    ...
    data() {
        return {
            books: [[
                ...
                {ind:8,title:'As Leeds Go Marching On', author:'Jonny Cooper', year:2026, showThoughts : false, thoughts : 'Despite being based on stats, this book does an excellent job at telling the story of Leeds United through history, and it is done in a fun and light-hearted way.', rating : 7},
